...
from .models import Student, Tutor, Course, Room, Schedule
...
class ScheduleList(admin.ModelAdmin):
    list_display = ('schedule_id', 'schedule_course_name', 'schedule_tutor_name', 'schedule_room_number', 'slug', 'price', 'available')
    list_filter = ('schedule_id', 'schedule_course_name', 'schedule_tutor_name', 'schedule_room_number', 'available')
